<x-Kasir.KasirLayouts><main class="content"><div class="container-fluid p-0">
    ...
    <body>
        <div class="container">
            ...
            <form id="formTransaksi" action="{{ route('kasir.transaksi.bayar.update', $transaksi->id) }}" method="POST"
...
<script>
 ...
 function toggleNonTunaiOptions() {
    ...
    function handleFormSubmit() {
        ...
        const numericId = @json($transaksi->id);
        
        // Open new tab for kwitansi
        const kwitansiUrl = "{{ url('/programhaji/kasir/transaksi/kwitansi/print') }}/" + numericId;
